...
def freq_arrays(invoice_list):
    ...
    for i in set([len(str(invoice)) for invoice in invoice_list]):
    ...
    for invoice in invoice_list:
        ...
        #QC on invoice - avoid special characters/AI misreads
        if invoice.isalnum() == True:
            ...
            #Update the array
            for index, character in enumerate(invoice):
